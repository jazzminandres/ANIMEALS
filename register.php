<?php
// UNUSED: ACCOUNT CREATION NOW RUNS THROUGH INDEX.PHP / PROFILESETUP.PHP / VERIFY.PHP.
// THIS FILE CREATES NEW ACCOUNTS AND STARTS EMAIL OR GOOGLE SIGNUP VERIFICATION.
...
if ($conn === false) { 
    // STOP EARLY IF THIS LEGACY REGISTER PAGE CANNOT REACH THE DATABASE.
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // COLLECT THE BASIC ACCOUNT FIELDS FROM THE LEGACY REGISTER FORM.
    ...
    if ($username && $password && $role) {
        ...
        // INSERT THE ACCOUNT INTO THE LEGACY USERS TABLE USED BY THIS OLD PAGE.
        $sql = "INSERT INTO USERS (USERNAME, PASSHASH, RANK, FULLNAME) VALUES ('$username', '$password', '$role', '$fullname')";
        $result = mysqlsrv_query($conn, $sql);
